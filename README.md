...
Run trimming.sh script to remove adaptor sequencing and clip where necessary (fastQC included before and after)
Run torunchipalignments.sh which runs chipalignments.sh to align to reference genome using bowtie2
