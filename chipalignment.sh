...
base=$1
fq=(`ls /home/ubelix/izb/bi18k694/PhD_analysis/supercoiling/analysis/scripts/reseq/trimmedreseq/${base}*.fq`) 
...
## set up file names
align_out=./reseq/${base}_unsorted.sam
align_bam=./reseq/${base}_unsorted.bam
align_sorted=./reseq/${base}_sorted.bam
align_filtered=./reseq/${base}_aln.bam
align_flag=./reseq/${base}_aln.txt
